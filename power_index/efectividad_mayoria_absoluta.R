...
# primero veremos efectividad en caso normal o 50+1
...
# en este caos los aprobados son 69 y los rechazadsos 47
...
veces_convencional_all$n_iniciativas_aprobadas <- 94
...
veces_convencional_all_rechazos$n_iniciativas_rechazadas <- 68

veces_convencional_all_rechazos$prop_efectividad_individual <- veces_convencional_all_rechazos$rechazos_existosos/veces_convencional_all_rechazos$n_encontra
...
# renormbraremos nuestras tablas como las tablas de la parte 1

aprobaciones_mayoria_absoluta <- veces_convencional_all

rechazos_mayoria_absoluta <- veces_convencional_all_rechazos

names(aprobaciones_mayoria_absoluta)
names(rechazos_mayoria_absoluta)

write_rds(aprobaciones_mayoria_absoluta,"temp/aprobaciones_mayoria_absoluta.rds")
write_rds(rechazos_mayoria_absoluta,"temp/rechazos_mayoria_absoluta.rds")
