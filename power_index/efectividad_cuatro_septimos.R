...
info_votaciones_aprobadas <- info_votaciones %>%
  filter(Resultado=='APROBADO' & TotalSI>=89)

info_votaciones_rechazadas_cuatro_septimos<- info_votaciones %>%
  filter(Resultado=='APROBADO' & TotalSI<89)
...
info_votaciones_rechazadas <- rbind(info_votaciones_rechazadas, info_votaciones_rechazadas_cuatro_septimos)




# en este caos los aprobados son 59 y los rechazadsos 57
...
veces_convencional_all$n_iniciativas_aprobadas <- 80
...
veces_convencional_all_rechazos$n_iniciativas_rechazadas <- 82
...
aprobaciones_cuatro_septimos <- veces_convencional_all

rechazos_cuatro_septimos <- veces_convencional_all_rechazos




write_rds(aprobaciones_cuatro_septimos,"temp/aprobaciones_cuatro_septimos.rds")
write_rds(rechazos_cuatro_septimos,"temp/rechazos_cuatro_septimos.rds")
